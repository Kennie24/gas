  ...
  (
    ...
    return (
      ...
      >
        ...
        <style dangerouslySetInnerHTML={{ __html: staticCss + dynamicCss }} />
                    ...
                    <div className="fx-track" ref={leftTrackRef}>
                      {sections.map((s, i) => (
                        <div
                          ...
                          onClick={() => goTo(i)}
                          role="button" tabIndex={0} aria-pressed={i === index}
                        >
                          {s.leftLabel}
                        </div>
                      ))}
...
const staticCss = `
  ...
  .fx-left-item.active::before { content: ""; position: absolute; top: 50%; transform: translateY(-50%); width: 6px; height: 6px; background: var(--fx-text); border-radius: 50%; left: 0; }
  .fx-right-item.active::after { content: ""; position: absolute; top: 50%; transform: translateY(-50%); width: 6px; height: 6px; background: var(--fx-text); border-radius: 50%; right: 0; }
  ...
  .fx-end { height: 40vh; display: grid; place-items: center; }
  .fx-fin { color: #aaa; font-size: 2rem; letter-spacing: normal; }
